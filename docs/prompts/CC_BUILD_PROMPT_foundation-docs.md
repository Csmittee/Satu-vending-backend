...
✅ COMPLETE — 2026-06-11 — foundation docs: WORKFLOW_SKILL (both repos already existed) + CHAT_HANDOFF (backend + firmware) + KNOWLEDGE_MAP (backend) + hardware README + rules split check (34 rules, no split) + R-83 + R-84
